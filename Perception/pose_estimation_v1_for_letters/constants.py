...
if is_real:
    ...
    # workspace
    # workspace_limits = np.asarray([[-0.307, 0.233], [-0.530, -0.245], [0.18, 0.4]])
    # workspace_limits = np.asarray([[-0.235, 0.213], [-0.678, -0.230], [0.18, 0.4]])
    workspace_limits = np.asarray([[-0.198, 0.158], [-0.665, -0.428], [0.18, 0.4]])
    # workspace_limits = np.asarray([[-0.230, 0.213], [-0.678, -0.235], [0.18, 0.4]])
else:
    # robot specs
    gripper_width = 0.02  # cm
...
depth_mean = [0.0020]
depth_std = [0.0073]
pretrain_color_mean = [0.0272, 0.0225, 0.0184]
pretrain_color_std = [0.1337, 0.1065, 0.0922]
pretrain_depth_mean = [0.0020]
pretrain_depth_std = [0.0073]
