...
"Ubuntu")
	...
	sudo apt install -y ros-noetic-effort-controllers ros-noetic-moveit ros-noetic-ompl ros-noetic-moveit-visual-tools ros-noetic-rosparam-shortcuts qt4-default libspnav0 python3-empy
	;;
esac
